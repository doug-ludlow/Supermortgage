...
export const roleQueueUnstaffed = (actor: Actor, p: { role: string; item_id: string; timer_id: string | null; environment: string }): Ev => ({ type: ROLE_QUEUE_UNSTAFFED, aggregate: { kind: "role_queue", id: p.role }, actor, payload: { ...p, cause: "SM_WORK_ITEM_AGE_5BD" } });

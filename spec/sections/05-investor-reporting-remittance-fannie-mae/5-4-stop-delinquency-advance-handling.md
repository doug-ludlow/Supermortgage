...
| `FNMA_F125_RECLASS_DESELECT_CD15` | deadline | Eligible for Deselection report (~CD11) — ONLY for loans in MBS pools issued June 1, 2007 through December 1, 2008 reported with a forbearance-plan (after the sixth consecutive month) or repayment-plan (18 months from plan start) status code | CD11 | by CD15 | deselection decision recorded (`human_portal_task` if deselecting) | sev-2 |

#### Business rules and calculations
1. **Applicability:** SDA applies to `remittance_type = SS` loans with `servicing_option = special` (MBS or portfolio). Regular servicing option S/S loans: advance until removal; expect Fannie Mae reclass selection at six consecutive months (A1-3-06) and reimbursement at reclass — the six-month selection carries no deselection window; the F-1-25 Eligible for Deselection report and the CD11–CD15 deselection decision apply only to loans in MBS pools issued June 1, 2007 through December 1, 2008 that are reported with a forbearance-plan or repayment-plan status code. S/A portfolio: IRM three-month interest rule (5.2). A/A: nothing advanced.
...
- **Regular servicing option loan (not eligible):** advances continue; watch the six-month reclass selection (A1-3-06, no deselection window); the F-1-25 deselection task exists only when the loan is in a June 1, 2007–December 1, 2008 MBS pool, is reported with a forbearance-plan or repayment-plan status code, and appears on the Eligible for Deselection report.
...
| 5.4-T5 | Given a regular servicing option S/S loan six consecutive months delinquent that is not reported with a forbearance-plan or repayment-plan status code, then no SDA is predicted, advances continue, and no deselection task is created (A1-3-06 six-month selection carries no deselection window); given a loan in an MBS pool issued June 1, 2007–December 1, 2008 reported with a forbearance-plan status code that appears on the Eligible for Deselection report (~CD11), then the deselection decision task is created on CD11 and due CD15. |

...
import { applySatisfiedOverrides_33_1 } from "./partner-book/timers-33-1.ts";
import { applySatisfiedOverrides_33_2 } from "./partner-book/timers-33-2.ts";
import { applySatisfiedOverrides_33_3 } from "./partner-book/timers-33-3.ts";
// ---- §34 process-owned files (scaffolded by tools/workflows/wire_orig.py)
import { applySatisfiedOverrides_34_1 } from "./operator-portal/timers-34-1.ts";
import { applySatisfiedOverrides_34_2 } from "./operator-portal/timers-34-2.ts";
import { applySatisfiedOverrides_34_3 } from "./operator-portal/timers-34-3.ts";
import { applySatisfiedOverrides_34_4 } from "./operator-portal/timers-34-4.ts";

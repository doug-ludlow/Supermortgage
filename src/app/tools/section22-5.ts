...
const exclusionEvidence = (i: ToolInput): ExclusionEvidence => { const e = (i.evidence as Record<string, unknown> | undefined) ?? i; return {
  ...
  payer_interested_party: e.payer_interested_party === true, payer_obligated_on_debt: e.payer_obligated_on_debt === true, rental_income_used_from_property: e.rental_income_used_from_property === true, collateral_kind: (optStr(e, "collateral_kind") as "financial_asset" | "virtual_currency" | null) }; };

...
export const PROMPT_VERSION = "32.16-p7";   // 32.16-T31 pins the version string; the 33.1 monitored-loan sentence below is captured by `agent_turns.context_hash`

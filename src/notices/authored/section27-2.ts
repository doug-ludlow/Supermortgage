/**
 * §27.2 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_27_2: VersionInput[] = [];
export const OVERRIDES_27_2: Record<string, Partial<NoticeTemplate>> = {};

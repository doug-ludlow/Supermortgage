...
test("29.4-T11: Given a post-purchase discovery on Mon Mar 8, 2027 that the delivered representative score should be 754 rather than 762, then a `post_purchase_adjustments` row is opened with `repricing_eligible = true` (acquisition Nov 19, 2026 + 18 months = May 19, 2028), the PPA .csv and evidence are prepared, and processing is expected by Tue Mar 23, 2027 (10 `business_days_fannie_et` after Mar 9: Mar 10, 11, 12, 15, 16, 17, 18, 19, 22, 23); given an LLPA delta of −$50, no draft is expected ($100 minimum).", async () => {
  ...
  // 10 business_days_fannie_et after Tue Mar 9, 2027 is Tue Mar 23 (Mar 10, 11, 12, 15, 16, 17, 18, 19, 22, 23 — no federal or SIFMA holiday in March), as R8 and the timer row state

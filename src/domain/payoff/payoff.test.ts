...
test("16.2-T1/T2/T3/T4/T5/T6/T7/T8: worked example ($1,551.47 collected, $1,489.42 to Fannie Mae, $62.05 fee, $200,989.42), S/S gap $505.58, tolerance, reliance, housekeeping, reversal", () => {
  ...
  assert.equal(M.fnmaShare({ type: "SS", upb_cents: cents("199500"), nib_cents: 0n, note_rate_pct: "6.250", ptr_pct: "6.000", lpi_due: D("2026-09-01"), payoff_on: D("2026-11-02"), mbs_pool: true, processed_bd1_reported_bd2: true }).interest_cents, 0n);
  assert.equal(M.fnmaShare({ type: "SS", upb_cents: cents("199500"), nib_cents: 0n, note_rate_pct: "6.250", ptr_pct: "6.000", lpi_due: D("2026-09-01"), payoff_on: D("2026-11-02"), processed_bd1_reported_bd2: true }).interest_cents, cents("997.50"), "portfolio S/S (no MBS pool): the BD1/BD2 exception does not apply");

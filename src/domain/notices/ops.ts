...
export function authorizationRequest(f: { received_on: PlainDate; requester_type: "attorney" | "counselor" | "lender_or_title" | "refinancing_lender" | "unknown"; evidence: boolean; authorization_received_on?: PlainDate | null }): { classification: ReturnType<typeof requesterAuthorization>; request_notice: "NTC_PAYOFF_AUTHORIZATION_REQUEST" | null; request_send_by: PlainDate | null; federal_due: PlainDate; federal_clock: typeof PAYOFF_FEDERAL_CLOCK; deliver_to: "requester" | "borrower_of_record"; requester_told_to_obtain_from_borrower: boolean; satisfying_event: { type: "payoff.statement.sent"; payload: { template: "NTC_REGZ_36C3_PAYOFF_STMT"; recipient: "requester" | "borrower_of_record" } } } {

/**
 * §30.4 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_30_4: VersionInput[] = [];
export const OVERRIDES_30_4: Record<string, Partial<NoticeTemplate>> = {};

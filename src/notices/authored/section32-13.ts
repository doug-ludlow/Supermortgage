/**
 * §32.13 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_32_13: VersionInput[] = [];
export const OVERRIDES_32_13: Record<string, Partial<NoticeTemplate>> = {};

...
const CHARGEOFF_RULES: ContentRule[] = [
  ...
  R("resumption", "§1026.41(e)(6)(ii) (additional information — (e)(6)(i)(B) lists the six explanations above)", "presence", "resume sending periodic statements, and no fee or interest charged during the suspension will be assessed retroactively", "resumption and no retroactive fees/interest"),
  R("within-30", "§1026.41(e)(6)(i)(B) (\"within 30 days of charge-off or the most recent periodic statement\" — the later anchor; 7.1 timer table)", "data_range", "days_after_anchor", "sent within 30 days of the charge-off / most-recent-statement anchor", { range: { max: 30 } }),
  CONTACT_RULE,
];
const CHARGEOFF_SAMPLE = { account_last4: "1234", chargeoff_date: "2026-11-03", balance_cents: 37104886n, days_after_chargeoff: 30, notice_anchor_on: "2026-11-03", notice_anchor_basis: "charge-off date", days_after_anchor: 30, ...CONTACT_SAMPLE };
...
const TPP_RULES: ContentRule[] = [
  ...
  R("different-amount", "comment 41(d)(2)-2 (7.1 rule 6 / T4)", "presence", "disclosed as a different amount because of your temporary loss mitigation program", "explanation that the amount due is disclosed as a different amount because of the temporary loss mitigation program (front page; a separate enclosed page or letter are the alternatives)"),
...
const PAYOFF_UPDATED_SAMPLE = { original_statement_date: "2026-10-15", reason: "an escrow tax disbursement was advanced", change_date: "2026-11-05", good_through: "2026-11-20", total_cents: 37640018n, previous_total_cents: 37228018n, per_diem_cents: 6481n, ...CONTACT_SAMPLE };
...
export const ARM_D_V11_RULES: ContentRule[] = [
  ...
  R("xi-cfpb-hud-hfa", "§1026.20(d)(2)(xi)", "presence", "HUD \\(800\\) 569-4287", "CFPB URL and HUD number (the state HFA itself is optional additional information)"),
  R("xi-hfa-bureau-site", "§1026.20(d)(2)(xi) (\"the Bureau Web site to access contact information for State housing finance authorities\")", "presence", "State housing finance authorities: (?:[a-z0-9-]+\\.)+(?:gov|org|com)", "the Bureau web site through which State housing finance authority contact information is accessed"),

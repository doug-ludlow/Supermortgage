...
**Discrepancies vs blueprint**: (1) "Per Fannie Mae approval" is now concrete: 30 days (subservicing) / 60 days (servicing), first business day of month; (2) system is Quick Exchange, not "Servicing Transfer Approvals" as a product name; (3) blueprint omits Form 101 at inception, Forms 1013/1014 via CBAM (mandatory Aug. 1, 2026), the Form 2017 prerequisite, the D-Code and the joint-and-several liability start date; (4) source conflict recorded (Form 629 timing): IRM 3-01 (10/13/2021) says Form 629 goes to the Regional Office "at least 60 days prior to the Effective Date" and that Form 629 "is only required for external transfers where the first five digits are different and it does not impact a sub-servicer transfer"; Servicing Guide A2-7-03 (05/13/2026) requires "the transferor or transferee servicer or subservicer" to submit Form 629 "30 days prior to the earlier of proposed sale or transfer date for subservicing transfers" and is the later, controlling text — `FNMA_A2_7_03_FORM629_SUBSERVICING_30` stays at 30 days; because the IRM note and the Transaction Type 32 layout (transferor/transferee lender numbers) tie the record to a change of servicer number, the `FNMA_IRM_TT32_TRANSFER_RECORD_15` loan-level record premise is doubtful for master-to-sub/sub-to-sub moves (open question 3; confirm with the Investor Reporting Representative).
...
3. Confirm whether the IRM Transaction Type 32 / CD25 cadence still applies post-eTransfer retirement and whether Transaction Type 32 is required at all for a master-to-sub/sub-to-sub move under one servicer number (IRM 3-01 note; confirm with the Investor Reporting Representative) (default: treat CD25 as the internal freeze date).

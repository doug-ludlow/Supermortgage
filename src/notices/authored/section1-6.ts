/**
 * §1.6 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_1_6: VersionInput[] = [];
export const OVERRIDES_1_6: Record<string, Partial<NoticeTemplate>> = {};

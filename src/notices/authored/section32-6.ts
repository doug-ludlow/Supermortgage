/**
 * §32.6 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_32_6: VersionInput[] = [];
export const OVERRIDES_32_6: Record<string, Partial<NoticeTemplate>> = {};

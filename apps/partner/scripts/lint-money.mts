/**
 * Money lint (apps/borrower's, unchanged): no float arithmetic on money or rates in the partner client — every figure is a bigint cents string formatted by lib/format.ts.

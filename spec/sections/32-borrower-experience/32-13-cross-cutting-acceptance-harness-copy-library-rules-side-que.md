...
Named as timers here but not registry codes (docs/ux/BACKEND-DELTAS.md): OIDC_EMAIL_UNVERIFIED, OIDC_INVALID, ACCOUNT_EXISTS, PASSWORD_WEAK, PASSWORD_WRONG, ACCOUNT_LOCKED, EMAIL_UNVERIFIED.

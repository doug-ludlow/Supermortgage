 ...
 *   purchase_advice.received{advice_date, net_proceeds_cents} · purchase_advice.reconciled{variance_cents} · loan.purchased{purchase_date, acquisition_date, first_payment_date} (once per loan)

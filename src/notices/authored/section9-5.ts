/**
 * §9.5 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_9_5: VersionInput[] = [];
export const OVERRIDES_9_5: Record<string, Partial<NoticeTemplate>> = {};

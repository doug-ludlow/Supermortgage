...
{{#block "terms" page=1 y=0.18 pt=11}}Your current rate {{current_rate_pct}}% to offered rate {{offered_rate_pct}}% ({{apr_pct}}% annual percentage rate (APR)); {{term_payments}} monthly principal-and-interest payments of {{money pi_cents}}; {{#if fixed}}fixed rate for the full term — the annual percentage rate will not increase{{else}}adjustable rate — the annual percentage rate may increase after consummation{{/if}}. Payments do not include amounts for taxes and insurance premiums, and your actual payment obligation will be greater.{{/block}}

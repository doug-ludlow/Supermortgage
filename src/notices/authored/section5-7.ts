/**
 * §5.7 process-owned notice versions (V(code, source, rules, sample, ruleSet, formBasis) from ./section01.ts) and
...
export const VERSIONS_5_7: VersionInput[] = [];
export const OVERRIDES_5_7: Record<string, Partial<NoticeTemplate>> = {};

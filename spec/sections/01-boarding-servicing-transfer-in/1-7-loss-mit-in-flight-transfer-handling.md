...
**Fannie Mae**: A2-7-03 — the transferee must "honor any forbearance agreements or other arrangements made with borrowers by the previous servicer"; the transferor must "identify ... any mortgage loans that are in foreclosure, bankruptcy, or subject to a workout option"; F-1-11 — "all pertinent information related to the status of any mortgage loan for which a workout option is being pursued." Workouts are decisioned and reported in SMDU (HSSN retired Dec. 1, 2025; research/00b F1); LL-2026-01 (eff. May 1, 2026): forbearance in ≤3-month increments with a 12-month cumulative cap from the initial start and no extension beyond a date that would result in the loan becoming greater than 12 months delinquent (Servicing Guide D2-3.2-01, 04/08/2026, which now carries the LL-2026-01 rule: plans "must not be extended beyond a date that would exceed a cumulative term of 12 months as measured from the start date of the initial forbearance plan, or result in the mortgage loan becoming greater than 12 months delinquent" — two independent limbs) — the transferor's forbearance history must carry over (research/00a §3.2); Flex Mod trial periods and Form 3179 per D2-3.2-06/F-1-27 (12.8). SMDU case continuity across a change of servicer number is **[UNVERIFIED — no public procedure found; for master-to-sub/sub-to-sub moves the case stays under the partner's servicer number]**.
...
**Discrepancies vs blueprint**: (1) "Continue prior deadlines" is only the general rule — for a complete application pending at transfer, (k)(3) sets a fresh 30-day clock from the transfer date; (2) the 10-day acknowledgment is business days (excluding legal public holidays, Saturdays and Sundays), not calendar days; (3) the trigger is broader than "complete app pending" — incomplete applications, appeals, pending offers and trial plans are all in scope; (4) SMDU is the system for workouts, but the blueprint omits SMDU case access under the partner's servicer number and the D2-3.2-01/LL-2026-01 forbearance carry-over (both limbs: cumulative 12 months from the initial start, and not greater than 12 months delinquent at term end).
...
| `FNMA_LL_2026_01_FORBEARANCE_CUMULATIVE_12M` | not_before_gate (12.4: `FNMA_LL202601_FORB_CUMULATIVE_12M` and `FNMA_LL202601_FORB_DELQ_12M`) | `loan.boarded{forbearance_history}` | `initial_start_date` | 12 months cumulative as measured from the start date of the initial forbearance plan AND the extension must not result in the loan becoming greater than 12 months delinquent (two independent limbs; Servicing Guide D2-3.2-01 (04/08/2026), which carries the LL-2026-01 rule) | `assertGateOpen` on forbearance extension | exception request template (12.4) |
...
- Forbearance carry-over: `cumulative_months` = Σ transferor increments; a new increment may not push cumulative > 12 months from `initial_start_date` (limb 1) and, independently, may not extend the plan beyond a date that would result in the loan becoming greater than 12 months delinquent (limb 2: projected `fnma_delinquency_status` at term end = months delinquent at the increment's start + increment months, 12.4's `FNMA_LL202601_FORB_DELQ_12M` test, must be ≤ 12 months) without Fannie Mae's prior written approval via the Forbearance Exception Request Template (Servicing Guide D2-3.2-01 (04/08/2026), which carries the LL-2026-01 rule). Worked case: a 9-month history starting Feb. 1, 2026 has 3 months of cumulative room; a 3-month extension is allowed when the loan is 9 months delinquent at its start (12 at term end) and refused when it is 10 months delinquent (13 at term end), even though the cumulative limb is met.

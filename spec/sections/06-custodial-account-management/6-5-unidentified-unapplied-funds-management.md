...
- Loss-mitigation trial (2.6): trial payments are not "partial payments"; C-1.1-02's Trial Period Plan subsection governs them (hold reduced trial payments as unapplied; apply when they total a full PITI payment; any residual at the end of the plan reduces the amounts to be capitalized) — excluded from the 30-day return clock.

...
| 5.3-T2 | Given a payoff processed Mon Nov 2, 2026 (BD1), then the AC 60 deadline is Tue Nov 3 17:00 ET and, for an S/S MBS loan, no full-month interest is charged if reported by BD2; for a portfolio S/S loan a full month's interest at PTR is still due. |
